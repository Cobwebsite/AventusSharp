...
internal class Delete
{
    ...
    public static DatabaseDeleteBuilderInfo PrepareSQL<X>(DatabaseDeleteBuilder<X> deleteBuilder, MsSqlStorage storage) where X : IStorable
    {
        ...
        result.Sql = "DELETE " + mainInfo.Alias + " FROM " + storage.QuoteIdentifier(mainInfo.TableInfo.SqlTableName) + " " + mainInfo.Alias
            + joinTxt
            + whereTxt;
