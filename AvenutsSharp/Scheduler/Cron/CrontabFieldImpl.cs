...
public class CrontabFieldImpl
{
    ...
    public CrontabFieldImpl(CrontabFieldKind kind, int minValue, int maxValue, string[]? names)
    {
        Debug.Assert(SysEnum.IsDefined(typeof(CrontabFieldKind), kind));
